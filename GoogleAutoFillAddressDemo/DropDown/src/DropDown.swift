...
public final class DropDown: UIView {
    ...
    var isDynamicHeight : Bool = false
    ...
    public var selectedIndexCell : Int?
	...
	*/
    @objc public dynamic var cornerRadius1 = DPDConstant.UI.CornerRadius {
		willSet {
	...
	*/
    @objc public dynamic var shadowColor1 = DPDConstant.UI.Shadow.Color {
	...
	Changing the shadow color automatically reloads the drop down.
	*/
    @objc public dynamic var shadowOffset1 = DPDConstant.UI.Shadow.Offset {
	...
	*/
    @objc public dynamic var shadowOpacity1 = DPDConstant.UI.Shadow.Opacity {
	...
	*/
    @objc public dynamic var shadowRadius1 = DPDConstant.UI.Shadow.Radius {
...
private extension DropDown {
	...
	func setupUI() {
		...
		tableViewContainer.layer.cornerRadius = cornerRadius1
        tableViewContainer.layer.shadowColor = shadowColor1.cgColor
		tableViewContainer.layer.shadowOffset = shadowOffset1
		tableViewContainer.layer.shadowOpacity = shadowOpacity1
		tableViewContainer.layer.shadowRadius = shadowRadius1

		tableView.rowHeight = cellHeight
		tableView.backgroundColor = tableViewBackgroundColor
		tableView.separatorColor = separatorColor
		tableView.layer.cornerRadius = cornerRadius1
...
extension DropDown: UITableViewDataSource, UITableViewDelegate {
	...
	fileprivate func configureCell(_ cell: DropDownCell, at index: Int) {
        ...
        //MITUL
        if selectedIndexCell != nil && selectedIndexCell == index {
            cell.optionLabel.textColor = selectionBackgroundColor
        }
